...
class userAuthController {
    ...
    //Register login get 
    async regLogGet(req, res) {
        return res.render('user/auth/reglog', { user: req.user });
    }
    ...
    async signUpPost(req, res) {
        try {
            ...
            if (existingUser) {
                ...
                return res.redirect(generateUrl('reglog'));
            }
    ...
    async signinPost(req, res) {
        try {
            ...
            if (user.role !== 'user') {
                req.flash('err', "Website only can access by user")
                return res.redirect(generateUrl('reglog'));
            }
