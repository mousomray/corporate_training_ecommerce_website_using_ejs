const AuthRepo = require('../repository/AdminRepo');
...
class adminAuthController {
    ...
    async registerGet(req, res) {
        return res.render('admin/auth/register', { user: req.user });
    }
    ...
    async registerPost(req, res) {
        try {
            ...
            const userData = {
                ...req.body, password: hashedPassword, image: req.file.path, role: 'admin'
            };
    ...
    async loginGet(req, res) {
        return res.render('admin/auth/login', { user: req.user });
    }
    ...
    async updatepasswordGet(req, res) {
        const categories = await CategoryRepo.allCategories();
        return res.render('admin/auth/updatepassword', { categories, user: req.user });
    }
