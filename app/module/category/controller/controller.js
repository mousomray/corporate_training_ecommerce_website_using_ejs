...
class categoryAdminController {
    ...
    async addcategoryGet(req, res) {
        ...
        res.render('admin/category/addcategory', { categories, user: req.user });
    }
    ...
    async showcategory(req, res) {
        try {
            const categories = await CategoryRepo.allCategories();
            res.render('admin/category/categorylist', { categories, user: req.user });
        } catch (error) {
            console.error(error);
    ...
    async singlecategory(req, res) {
        ...
        try {
            ...
            res.render('admin/category/editcategory', { categories, category, user: req.user });
        } catch (error) {
    ...
    async catwiseproduct(req, res) {
        ...
        try {
            ...
            const categories = await CategoryRepo.allCategories();
            res.render('admin/category/catwiseproduct', { categories, mydata, user: req.user });
        } catch (error) {
